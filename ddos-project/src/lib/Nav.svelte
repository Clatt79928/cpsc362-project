...
<body class = m-0>
<nav class="flex items-center justify-center flex-wrap bg-amber-600 p-6">
    ...
    <div class="w-full inline-block flex-grow lg:flex lg:items-center lg:w-auto">
      <div class="text-sm lg:flex-grow">
        ...
        <a href="/graphs" class="block mt-4 lg:inline-block lg:mt-0 text-sky-50 hover:text-white mr-4">
          Graphs
        </a>
        <a href="/srclink" class="block mt-4 lg:inline-block lg:mt-0 text-sky-50 hover:text-white mr-4">
          Source Code
        </a>
      </div>
    </div>
